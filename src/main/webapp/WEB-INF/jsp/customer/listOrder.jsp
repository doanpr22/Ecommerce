...
<section>
    <c:forEach var="order" items="${listOrder}">
        <c:if test="${order.getOrderDestailsList().size()!=0}">
                    ...
                    <table id="cart" class="table table-hover table-condensed col-md-8"> 
                        ...
                        <tbody>
                            ...
                            <td class="actions" data-th="">
                                <a class="btn btn-danger btn-sm" id="delete-card" href="<%=request.getContextPath()%>/customer/deleteOrderDestails?idOrderDestails=${orderDestails.id}"><i class="fa fa-trash"></i>
                                </a>
                            </td> 
                            </tr>
                        </c:forEach>
                            ...
                            <tr> 
                                <td colspan="2" class="hidden-xs float-right">Tổng tiền:  </td> 
                                <td colspan="2" class="hidden-xs text-center"><strong>${order.sumPrice}</strong>
                                </td> 
                                <td>

                                    <a href="<%=request.getContextPath()%>/payment/all" class="btn btn-success btn-block"> <i class='fab fa-amazon-pay' style='font-size:20px;color:#155BF2'></i>Thanh toán<i class="fa fa-angle-right"></i></a>
                                </td> 
                            </tr> 
                        </tfoot> 
                    </table>
