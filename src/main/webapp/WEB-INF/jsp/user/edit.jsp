...
<section>
    ...
    <ul class="list-sp">
        <c:forEach var="product" items="${productlist}">
            <li class=" border">
                <div class="product-img"><a href="sendedit?id=${product.id}"><img src="<%=request.getContextPath()%>${product.urlImage}"></a></div>
                <div class="product-info">
                    <div class="title text-center"><a href="saveedit?id=${product.id}"><span><i>${product.productName} ${product.productDestails.bonhotrong} <br>Chính hãng</i></span></a></div>
                    <div class="price">
